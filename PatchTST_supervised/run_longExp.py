...
if __name__ == '__main__':
    ...
    # parser.add_argument('--aug', type=int, default=0, help='0: no aug 1: distance aug 2: normal aug 3: slope aug')
    ...
    parser.add_argument('--d_mix', type=int, default=256, help='feature_mix dim')
